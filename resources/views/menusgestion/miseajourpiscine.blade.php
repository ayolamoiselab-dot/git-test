...
<div class="container">
    <h1>Gestion des Versements de Piscine</h1>
    <!-- Formulaire de recherche par nom -->
    <form action="{{ route('piscine.recherche') }}" method="POST">
        @csrf
    ...
    @isset($eleve)
        <div class="cardscosco">
            <div class="cardsco-body">
                ...
                <form action="{{ route('piscine.miseajour', $eleve->id_eleve) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="frais_transport">Frais de piscine :</label>
                        <input type="number" name="frais_piscine" id="frais_piscine" value="{{ $eleve->frais_piscine }}" class="form-control" >
                    </div>
                    <div class="form-group">
