...
<div class="container">
    <h1>Gestion des Versements de transport</h1>
    <!-- Formulaire de recherche par nom -->
    <form action="{{ route('transport.recherche') }}" method="POST">
        @csrf
    ...
    @isset($eleve)
        <div class="cardscosco">
            <div class="cardsco-body">
                ...
                <form action="{{ route('transport.miseajour', $eleve->id_eleve) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="frais_transport" id="frais_transport" value="{{ $eleve->frais_transport }}" class="form-control" >
                    </div>
                    <div class="form-group">
