...
@section("title", "Gestion du transport")
@section("content")

<main class="page-content">
    <div class="search-bar">
        <form method="POST" action="{{ route('recherche.transport') }}">
            @csrf
...
@endif
    ...
    @if (isset($eleve))
        ...
        <div class="cantine-form">
            <form method="POST" action="{{ url('/enregistrer-transport') }}">
                @csrf
                ...
                <div>
                    <label>Tarif par mois</label>
                    <input type="number" name="tarif_mois" required>
                </div>

                <div>
                    <label>Type de trajet</label>
                    <select name="type_trajet" required>
