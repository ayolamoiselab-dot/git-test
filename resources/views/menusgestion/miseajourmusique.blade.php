...
<div class="container">
    <h1>Gestion des Versements de Musique</h1>
    <!-- Formulaire de recherche par nom -->
    <form action="{{ route('musique.recherche') }}" method="POST">
        @csrf
    ...
    @isset($eleve)
        <div class="cardscosco">
            <div class="cardsco-body">
                ...
                <form action="{{ route('musique.miseajour', $eleve->id_eleve) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="frais_transport">Frais de musique :</label>
                        <input type="number" name="frais_musique" id="frais_musique" value="{{ $eleve->frais_musique }}" class="form-control" >
                    </div>
                    <div class="form-group">
